        ...
        <div className="project__main">
          <div data-aos="fade-left" className="project__right">
            ...
            <p className="project__description project__body">
              A <span className="project__specialText">full-stack note-taking app</span> designed to provide users with a reliable and secure platform for managing their notes. <span className="project__specialText">Note</span> offers a seamless experience, with a backend architecture that ensures data consistency, security, and accessibility.
