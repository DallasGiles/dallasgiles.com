      ...
      <article className="project dark">
        <div className="project__main">
          <div data-aos="fade-left" className="project__right">
            <h3 className="project__titleDark">NoteMaster</h3>
            <p className="project__description project__body">
              A <span className="project__specialText">full-stack note-taking app</span> designed to provide users with a reliable and secure platform for managing their notes. <span className="project__specialText">NoteMaster</span> offers a seamless experience, with a backend architecture that ensures data consistency, security, and accessibility.
            ...
            <p className="project__tech project__body">
              &gt; Node.js · Express · MongoDB · AWS S3 · JWT Authentication
            </p>
            <a
          ...
          <img
            ...
            src="/images/note-master-home.png"
            sizes="50vw"
