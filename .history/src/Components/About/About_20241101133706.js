    ...
    <section id="about" className="about">
      <div data-aos="fade-right" className="about__text">
        ...
        <p className="about__body">
           ...
           <span className="about__specialText">sustainable</span>, require less  <span className="about__specialText">consumption</span>consumption, and encourage continuous learning.
        </p>
        <br />
        <p className="about__body">
